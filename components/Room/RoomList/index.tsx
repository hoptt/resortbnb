...
import { useRoomItem } from "./useRoomItem";
import { useRoomLikeItem } from "./useRoomLikeItem";
...
export function RoomLikeItem({
  ...
  const { handleLike, isLike } = useRoomLikeItem(like, queryKey);

  return <RoomCard handleLike={handleLike} isLike={isLike} room={like.room} />;
}
...
export function RoomItem({
  ...
  const { handleLike, isLike } = useRoomItem(room, queryKey);

  return <RoomCard handleLike={handleLike} isLike={isLike} room={room} />;
}
